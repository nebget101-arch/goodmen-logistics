...
export const PERMISSIONS = {
  ...
  // IFTA quarterly filing module
  IFTA_VIEW: 'ifta.view',
  IFTA_EDIT: 'ifta.edit',
  IFTA_IMPORT: 'ifta.import',
  IFTA_RUN_AI_REVIEW: 'ifta.run_ai_review',
  IFTA_FINALIZE: 'ifta.finalize',
  IFTA_EXPORT: 'ifta.export',
...
export const TAB_PERMISSIONS: Record<string, string[]> = {
  ...
  fmcsa_safety: [PERMISSIONS.FMCSA_SAFETY_VIEW, PERMISSIONS.FMCSA_SAFETY_MANAGE, PERMISSIONS.FMCSA_SAFETY_SCRAPE],
};
