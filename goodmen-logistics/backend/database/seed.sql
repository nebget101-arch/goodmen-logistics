...
VALUES
    (uuid_generate_v4(), 'Garland Main Warehouse', '1234 Industrial Blvd, Garland, TX', '{}', NOW(), NOW()),
    (uuid_generate_v4(), 'Rockwall Shop', '9101 I-30 Frontage Rd, Rockwall, TX', '{}', NOW(), NOW()),
    (uuid_generate_v4(), 'Garland Shop', '5678 Service Rd, Garland, TX', '{}', NOW(), NOW()),
    (uuid_generate_v4(), 'Hutchins Shop', '2222 Logistics Way, Hutchins, TX', '{}', NOW(), NOW());
-- Insert Drivers
