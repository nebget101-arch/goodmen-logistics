...
const ROLE_PERMISSIONS = {
  ...
  carrier_accountant: ['dashboard.view', 'invoices.view', 'invoices.create', 'invoices.edit', 'invoices.bill', 'accounting.view', 'accounting.manage', 'settlements.view', 'reports.view', 'reports.export'],
